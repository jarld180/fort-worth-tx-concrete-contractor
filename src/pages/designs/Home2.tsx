...
const Home2: React.FC<HomeProps> = ({ cityName = "Fort Worth" }) => {
  const isDallas = cityName === "Fort Worth";
          ...
          <div className="space-y-20">
            ...
            <div className="flex flex-col gap-12 border-t border-gray-200 pt-20">
              <div className="group">
                ...
                <a href="tel:(817) 580-5810" className="text-4xl font-light hover:italic transition-all text-black underline underline-offset-[12px] decoration-blue-200">743.228.2305</a>
              </div>
            </div>
          </div>
