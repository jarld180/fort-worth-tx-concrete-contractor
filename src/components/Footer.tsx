      ...
      <div className="max-w-[1600px] mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            <div className="flex items-start space-x-2 mb-8 text-black">
              ...
              <span className="text-2xl font-extrabold tracking-tight uppercase text-black">
                Fort Worth <span className="text-black">Concrete</span>
              </span>
            </div>
            <p className="text-black text-lg mb-8 max-w-sm">
              Fort Worth's premier concrete contractors specializing in high-end residential and commercial projects. Building foundations for a lifetime.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/" className="text-black hover:text-black transition-colors font-medium">Fort Worth, TX</Link></li>
        ...
        <div className="pt-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start text-sm text-black">
          <p>© 2026 Fort Worth Concrete. All rights reserved. (817) 580-5810</p>
